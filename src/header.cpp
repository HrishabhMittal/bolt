...
std::vector<std::string> keywords = {"if",   "else",   "while",  "break",    "continue", "const",   "for", "struct",
                                     "impl", "return", "extern", "function", "import",   "package", "as",  "void",
                                     "bool", "string", "true",   "false",    "u8",       "u16",     "u32", "u64",
...
bool Token::operator==(const char *c) { return c == value; }

bool operator==(const Token &t1, const Token &t2) { return t1.ttype == t2.ttype && t1.value == t2.value; }
